...
def welcome(first_name: str | None = None) -> str:
    ...
    return (
        ...
        "وب‌سایت، اتوماسیون فرایندها، ربات پیام‌رسان، سیستم انبارداری و هویت بصری.\n\n"
...
def about() -> str:
    return (
        f"<b>دربارهٔ {BRAND}</b>\n\n"
        "ما یک تیم فنی سه‌نفره هستیم: توسعهٔ رابط کاربری، معماری و زیرساخت، و راهبرد کسب‌وکار.\n\n"
        "طرز کارمان ساده است:\n"
...
def services() -> str:
    return (
        ...
        f"<b>{BULLET} طراحی گرافیک و هویت بصری</b>\n"
        "لوگو، ست اداری، بنر و محتوای بصری منسجم.\n\n"
